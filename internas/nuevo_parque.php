...
<body>
    ...
    <section>
        ...
        <h2>Ingresar datos del nuevo parque</h2>
        ...
        <article>
            ...
            <form action="insertar_parque.php" method="post">
                <label for="nombre">Nombre:</label>
                <input type="text" name="nombre" id="nombre" required />
                <br />
                <br />
                <label for="extension">Extension (hectáreas)</label>
                ...
                <br />
                <br />
                <label for="anio_inauguracion">Año de inauguración:</label>
                <input type="number" name="anio_inauguracion" id="anio_inauguracion" required />
                <br />
                <br />
